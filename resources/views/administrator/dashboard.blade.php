...
<div class="container-fluid bg-body-secondary min-vh-100 py-4 px-md-5">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-3 border-bottom">
        <div>
            <h4 class="fw-bold text-body m-0 tracking-tight">Overview Dashboard</h4>
            <p class="text-body small m-0 mt-1">Selamat datang kembali, {{ auth()->user()->name }}. Berikut adalah ringkasan data restoran Anda hari ini.</p>
        </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card border-0 shadow-sm rounded-3 bg-body p-3 h-100">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <span class="text-muted small fw-bold text-uppercase d-block mb-1">Total Menu</span>
                        <h3 class="fw-bold text-body m-0">{{ \App\Models\Menu::count() }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-body p-3 h-100">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-body m-0">{{ \App\Models\Article::count() }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-body p-3 h-100">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-body m-0">{{ \App\Models\Banner::where('is_active', 1)->count() }}</h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 bg-body p-3 h-100">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h3 class="fw-bold text-body m-0">{{ App\Models\Messages::count() }}</h3>
                    </div>
                                ...
                                @forelse($recentMessages as $msg)
                                    <tr class="border-bottom">
                                        <td class="py-3 ps-0" style="width: 30%">
                                            <span class="text-body fw-bold d-block">{{ $msg->name }}</span>
        ...
        <div class="col-12 col-lg-5">
            <div class="card border-0 shadow-sm rounded-3 bg-body h-100">
                <div class="card-header bg-body border-0 pt-4 px-4 pb-2">
                    <h6 class="fw-bold text-body m-0"><i class="bi bi-star me-2 text-warning"></i>Featured Items</h6>
                </div>
                <div class="card-body px-4 pb-4 pt-1">
                        ...
                        @forelse($featuredMenus as $menu)
                            <div class="d-flex align-items-center justify-content-between p-2 rounded-3 bg-body-tertiary">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <span class="text-body fw-bold d-block" style="font-size: 13px;">{{ $menu->name }}</span>
