...
<div class="container-fluid bg-body-secondary min-vh-100 py-4 px-md-5">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-3 border-bottom">
        <div>
            <h4 class="fw-bold text-body m-0 tracking-tight">Menu Management</h4>
            <p class="text-body small m-0 mt-1">Kelola daftar menu makanan, kategori, serta harga secara real-time</p>
        </div>
    ...
    <div class="row g-3 justify-content-end align-items-center mb-4">
        <div class="col-12 col-md-auto d-flex gap-2">
            <select id="filterCategory" class="form-select border-0 shadow-sm py-2 rounded-3 text-body bg-body" style="min-width: 180px;">
                <option value="" class="text-start text-muted small">Semua Kategori</option>
                @foreach ($categories as $cat)
                    <option value="{{ $cat->id }}" class="text-start text-muted small">{{ $cat->name }}</option>
                @endforeach
            </select>
            ...
            <div class="input-group shadow-sm bg-body rounded-3 overflow-hidden" style="min-width: 260px;">
                ...
                <input type="text" id="search" class="form-control bg-body text-body border-0 py-2 shadow-none" placeholder="Cari menu">
            </div>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden bg-body">
        <div class="table-responsive">
            <table class="table table-hover table-borderless align-middle mb-0 w-100">
                <thead class="text-center text-secondary small fw-bold text-uppercase border-bottom">
                    <tr>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered"> 
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-header border-bottom-0 pt-4 px-4 pb-2">
                <h5 class="modal-title fw-bold text-body" id="createMenuModal">Add New Menu</h5>
            </div>
                ...
                <div class="modal-body px-4 pb-0">
                    <div class="row g-3">
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                            <div class="text-center bg-body-tertiary p-3 rounded-3 border border-2 border-dashed border-secondary-subtle h-100 d-flex flex-column justify-content-center align-items-center" style="min-height: 220px;">
                                <img id="preview" width="140" height="140" class="rounded-3 shadow-sm mb-3 object-fit-cover d-none" alt="Preview">
                                <i class="bi bi-image text-secondary display-5 mb-2"></i>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3" id="name" name="name" placeholder="Masukkan nama menu" required>
                            </div>

                            <div class="mb-3">
                                <label for="category_id" class="form-label small fw-bold text-secondary mb-1">Category</label>
                                <select name="category_id" id="category_id" class="form-select bg-body-tertiary text-body border-0 py-2 rounded-3" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3" id="price" name="price" placeholder="Contoh: 25000" required>
                            </div>

                            <div class="mb-3">
                                <label for="description" class="form-label small fw-bold text-secondary mb-1">Description</label>
                                <textarea class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 textarea-fixed" id="description" name="description" rows="2" placeholder="Tulis deskripsi singkat..." required></textarea>
                            </div>

                            <div class="form-check form-switch mt-2 p-2 bg-body-tertiary rounded-3 ps-5">
...
<div class="modal fade" id="updateMenu" tabindex="-1" aria-labelledby="updateMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered"> 
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-header border-bottom-0 pt-4 px-4 pb-2">
                <h5 class="modal-title fw-bold text-body" id="updateMenuModalLabel">Edit Menu Data</h5>
            ...
            <form method="POST" id="formUpdateMenu" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 pb-0">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                            <div class="text-center bg-body-tertiary p-3 rounded-3 border border-secondary-subtle h-100 d-flex flex-column justify-content-center align-items-center" style="min-height: 220px;">
                                ...
                                <label for="edit-image" class="form-label text-secondary small fw-bold d-block">Ubah Gambar (Kosongkan jika tidak diganti)</label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3" id="edit-name" name="name" required>
                            </div>

                            <div class="mb-3">
                                <label for="edit-category" class="form-label small fw-bold text-secondary mb-1">Category</label>
                                <select name="category_id" id="edit-category" class="form-select bg-body-tertiary text-body border-0 py-2 rounded-3" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3" id="edit-price" name="price" required>
                            </div>

                            <div class="mb-3">
                                <label for="edit-description" class="form-label small fw-bold text-secondary mb-1">Description</label>
                                <textarea class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 textarea-fixed" id="edit-description" name="description" rows="2" required></textarea>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-body text-center p-4">
                ...
                <h5 class="fw-bold text-body mb-1">Hapus Menu?</h5>
