...
<div class="container-fluid bg-body-secondary min-vh-100 py-4 px-md-5">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 pb-3 border-bottom border-light-subtle">
        <div>
            <h4 class="fw-bold text-body m-0 tracking-tight">Banner Management</h4>
            <p class="text-body small m-0 mt-1">Atur spanduk promo, pengumuman, dan konten *slider* utama halaman depan</p>
        </div>
    ...
    <div class="row g-3 justify-content-end align-items-center mb-4">
        <div class="col-12 col-md-auto d-flex gap-2">
            <select id="filterStatus" class="form-select border-0 shadow-sm py-2 rounded-3 text-body bg-body" style="min-width: 160px;">
                <option value="" class="text-start text-muted small">Semua Status</option>
                <option value="1" class="text-start text-muted small">Aktif</option>
                <option value="0" class="text-start text-muted small">Tidak Aktif</option>
            </select>

            <div class="input-group shadow-sm bg-body rounded-3 overflow-hidden" style="min-width: 260px;">
                <span class="input-group-text bg-body border-0 text-body pe-0">
                    <i class="bi bi-search"></i>
                </span>
                <input type="text" id="search" class="form-control bg-body text-body border-0 py-2 shadow-none" placeholder="Cari judul banner...">
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered"> 
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-header border-bottom-0 pt-4 px-4 pb-2">
                <h5 class="modal-title fw-bold text-body" id="createBannerModal">Add New Banner</h5>
            </div>
                ...
                <div class="modal-body px-4 pb-0">
                    <div class="row g-3">
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                            <div class="text-center bg-body-tertiary p-3 rounded-3 border border-2 border-dashed border-secondary-subtle h-100 d-flex flex-column justify-content-center align-items-center" style="min-height: 250px;">
                                ...
                                <input type="file" class="form-control form-control-sm bg-body text-body border-secondary-subtle mt-2" id="image" name="image" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="title" name="title" placeholder="Masukkan judul utama spanduk" required>
                            </div>

                            <div class="mb-2">
                                <label for="subtitle" class="form-label small fw-bold text-secondary mb-1">Subtitle</label>
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="subtitle" name="subtitle" placeholder="Masukkan sub-judul (opsional)">
                            </div>

                            <div class="row g-2 mb-2">
                                <div class="col-6">
                                    <label for="start_date" class="form-label small fw-bold text-secondary mb-1">Start Date</label>
                                    <input type="date" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="start_date" name="start_date" required>
                                </div>
                                <div class="col-6">
                                    <label for="end_date" class="form-label small fw-bold text-secondary mb-1">End Date</label>
                                    <input type="date" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="end_date" name="end_date" required>
                                </div>
                            </div>

                            <div class="form-check form-switch mt-3 p-2 bg-body-tertiary rounded-3 ps-5">
...
<div class="modal fade" id="updateBanner" tabindex="-1" aria-labelledby="updateBannerModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered"> 
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-header border-bottom-0 pt-4 px-4 pb-2">
                <h5 class="modal-title fw-bold text-body" id="updateBannerModalLabel">Edit Banner</h5>
            </div>
            <form method="POST" id="formUpdateBanner" enctype="multipart/form-data">
                ...
                <div class="modal-body px-4 pb-0">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-between">
                            <div class="text-center bg-body-tertiary p-3 rounded-3 border border-secondary-subtle h-100 d-flex flex-column justify-content-center align-items-center" style="min-height: 250px;">
                                ...
                                <label for="edit-image" class="form-label text-secondary small fw-bold d-block">Ubah Spanduk (Kosongkan jika sama)</label>
                                <input type="file" class="form-control form-control-sm bg-body text-body border-secondary-subtle mt-2" id="edit-image" name="image">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="edit-title" name="title" required>
                            </div>

                            <div class="mb-2">
                                <label for="edit-subtitle" class="form-label small fw-bold text-secondary mb-1">Subtitle</label>
                                <input type="text" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="edit-subtitle" name="subtitle">
                            </div>

                            <div class="row g-2 mb-2">
                                <div class="col-6">
                                    <label for="edit-start_date" class="form-label small fw-bold text-secondary mb-1">Start Date</label>
                                    <input type="date" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="edit-start-date" name="start_date" required>
                                </div>
                                <div class="col-6">
                                    <label for="edit-end_date" class="form-label small fw-bold text-secondary mb-1">End Date</label>
                                    <input type="date" class="form-control bg-body-tertiary text-body border-0 py-2 rounded-3 form-control-sm" id="edit-end-date" name="end_date" required>
                                </div>
                            </div>

                            <div class="form-check form-switch mt-3 p-2 bg-body-tertiary rounded-3 ps-5">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1" id="edit-is-active">
                                <label class="form-check-label small fw-bold text-secondary" for="edit-is-active">Banner Active</label>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg rounded-4 bg-body text-body">
            <div class="modal-body text-center p-4">
                ...
                <h5 class="fw-bold text-body mb-1">Hapus Banner?</h5>
